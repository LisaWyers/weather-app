...
describe("tests forecast details", () => {
  ...
  it("renders correct values for props", () => {
    ...
    expect(getByText("22°C")).toHaveAttribute(
      "class",
      "forecast-details_temperature"
    );
    expect(getByText("7")).toHaveAttribute(
      "class",
    ...
    expect(getByText("north")).toHaveAttribute(
      "class",
      "forecast-details_direction"
    );
    expect(getByText("70")).toHaveAttribute(
      "class",
